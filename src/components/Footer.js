      ...
      <div className="container text-md-left">
        <div className="row text-md-left">
          <div className="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p>
              AutoCare Lanka is your trusted partner in providing top-notch
              automotive care services. We ensure your vehicle receives the best
          ...
          <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
            ...
            <p>
              <i className="fas fa-home mr-3"></i> 66, Attidiya Road,
          ...
          <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p>
              <i className="far fa-clock mr-3"></i> Mon - Fri : 9 AM - 6 PM
            </p>
            <p>
              <i className="far fa-clock mr-3"></i> Sat - Sun : 9 AM - 6 PM
            </p>
            <h5 className="text-uppercase mt-4 mb-4 font-weight-bold">
              Follow Us
            </h5>
