...
const Calendar = () => {
  ...
  const fetchAvailableSlots = async () => {
    try {
      console.log('[BookingStation01][Calendar] API call start: get_calendar', {
      ...
      console.log('[BookingStation01][Calendar] API call success');
      ...
      console.error('[BookingStation01][Calendar] API call failed', error?.message);
